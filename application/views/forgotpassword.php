...
echo form_open('login/updatepassword',$attr);
$style=''; 
$recnum=$this->session->userdata('recnum');
$res=$this->admin_model->emailDetails4patient($recnum);
?>
...
<div class="col-sm-9">
	<input type="text" class="form-control input-sm" id="email" name="email" autofocus="autofocus" autocomplete="off"  required="required" 
