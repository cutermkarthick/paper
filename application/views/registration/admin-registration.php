...
<div class="span6"> <h1>Welcome to New Admin</h1></div> 
<div class="row-fluid">
<div class="span9">
...
<div class="controls">
<input type="text" name="clinicname" id="clinicname" placeholder="Enter the Clinic Name">
</div>
</div>
...
text-align:center">
<a class="btn btn-success btn-lg" style="padding:8px 16px" id="btnNextContact" onclick="javascript:check_req_fields4newregistration4admin()" > 
SAVE</a>
</div>
</li>
</ul>	
