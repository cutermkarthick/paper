...
//var new_val=health_iss.replace(/\s/g, '');
//var new_match=$('#'+new_val).attr("value");
//$("#"+new_match.replace(/\s/g, '')).next().css("color", "#FFFFFF");
}
});
...
document.getElementById('witness').value='<?php echo $patient_sig->witness_name ?>';
<?}?>
*/
...
var health_iss=document.getElementById('health_iss').value;
   ...
   {
type: 'POST',
url: "<?php echo base_url();?>doctor_ctrl/gethealth_details/"+recnum+"/"+med_history_rec+"/"+upd_num+'/'+health_iss,success:function(response)
        {
...
<div class="controls">
<textarea rows="5" cols=20 name='notes' id='notes'>
  <?=$notes ?></textarea>
</div>
</div>  
...
<div class="control-group">
<label class="control-label" for="inputPassword" 
style='float: left; width:350px;  padding-top: 5px;  text-align: left;'>Post Surgery Communication To Do List(day of Surgery) for Patient </label>
<div class="controls">
<textarea rows="5" cols=20 name='to_do' id='to_do'>
  <?=$to_do ?></textarea>
</div>
</div>
...
<div class="controls">
<input type="text"  name='name_of_insured' id='name_of_insured' placeholder="Name" value="<?= $name_of_insured ?>" >
</div>
</div>	
...
<div class="controls">
<input type="text" placeholder="Company Name" value="<?= $insurance_company ?>" name='insurance_company' id='insurance_company'>
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputPassword">Group ID</label>
<div class="controls">
<input type="text" placeholder="ID" name='group_id'  id='group_id' value="<?= $group_id ?>">
</div>
</div>
...
<div class="controls">
<input type="text" placeholder="ID"  name='member_id' id='member_id' value="<?= $member_id ?>">
</div>
</div>
